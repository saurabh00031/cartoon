...
var hackerearth_url="https://www.hackerearth.com/@shruti0611";
var codechef_url="https://www.codechef.com/users/shrutigujar702";
var github_url="https://github.com/shruti-611?tab=repositories";
var gmail_url="";
var inst_text;
var bug;
var bug_tween;
...
//	game.load.onLoadStart.add(loadStart, this);
  ...
  //  game.stage.scale.startFullScreen();
   ...
   //game.canvas.addEventListener('touchenter', function(){ console.log("You touched here!!");}, false);
	...
	jstext.alpha = 0.2;
	ctext.alpha = 0.2;
	game.add.text(5200,h-140,'Skills and tech stack',style_roboto);
   ...
   //Add Explosion object pool
	...
	game.add.text(2930,h-250,"Class 10th \n 92% marks \n ( School 4th Topper ) ", style);
	game.add.text(3330,h-280,"Class 12th \n 77% marks \n State Board ", style);
	game.add.text(3730,h-310,"Joined Shivpratap academy,Vita \n but \n Sad moments are low \n JEE marks \n & CET marks ", style);
	...
	game.add.text(5200,h-70,'',{font:"20px monospace",fill:"#fff"});
	...
	var style_ex1 = {font:"32px Arial",fill:orange,align:"center"};
	...
	game.add.text(11420,h-290,"Holiday Destination is Mama's House !",style_ex1);
...
//	game.add.text(13300,h-430,"Developed meta-data tracking\nstructures for large storage devices \n using Boost C++ and \n Boost Python Libraries.",style_white);
	...
	game.add.sprite(14100,h-370,'');
	var ambu = game.add.sprite(14200,h-260,'');
	...
	game.add.sprite(14800,h-420,'');
	game.add.text(14850,h-450,"My quotes:",style_white);
	//Add Achivements Section
	game.add.tileSprite(base5+500,h-100-73*3,139*2,73*3,'brick');
	shakti = game.add.sprite(base5+1200,-500,'');
	shakti.scale.setTo(0.6,0.6);
	shakti_cup = game.add.sprite(base5+500,-500,'cup');
	shakti_cup.scale.setTo(0.5,0.5);
	game.add.text(base5+505,h-300,"I hate expectations of people !",style_white);
	...
	game.add.sprite(base5+1190,h-330,'');
	game.add.text(base5+1180,h-250,"I like to participate in events and festivals",style_position);

	
	cup2=game.add.sprite(base5+1400,-340,'');
	cup2.scale.setTo(0.8,0.8);
	game.add.sprite(base5+1630,h-390,'');
	game.add.text(base5+1580,h-250,"",style_position);

	

	cup3=game.add.sprite(base5+1820,-410,'');
	game.add.sprite(base5+2060,h-410,'');
	game.add.text(base5+2080+50,h-310,"I believe in beauty of my dreams !!!",style_position);

	game.add.text(base5+2060,h-305+50,"I got lot to learn from fake people !!!",style_position);
	game.add.sprite(base5+2170,h-310+50,'');
	game.add.text(base5+2060,h-205+30,"I will prove i m best  !!!",style_position);
	game.add.sprite(base5+2150,h-210+30,'').scale.setTo(0.15,0.15);
	...
	game.add.text(base5+3250,h-470,"Rank under 3600 in google kickstart ",{font:"30px Arial",fill:"#fff",align:"center"});

	game.add.sprite(base5+3670,h-310,'');
	game.add.text(base5+3650,h-470,"Qualified for \nfinals \n as top 10 team in 300 teams in Hack O Furiesta !",{font:"30px Arial",fill:"#fff",align:"center"});

	//Add other highlights
	game.add.sprite(base6+600,h-240,'');
	game.add.text(base6+600,h-330,"Relatives like me but \n vice versa is not true",style_white);
	shakti2 = game.add.sprite(base6+930,-500,'');
	...
	game.add.sprite(base6+1200,h-450,'');
	game.add.sprite(base6+1600,h-400,'');
	game.add.text(base6+1240,h-500,"Holds Yoga Session with my favourite relatives !.",style_white);
	game.add.text(base6+1400+20,h-360,"I M RSS student...I serve the nation !.",style_white);
	...
	game.add.text(base7+720,h-120,"",style_white);
	...
	*/
	...
	game.add.text(4300,h-120,"Scored 9.3 pointer marks in DY patil university,Kolhapur.",style_roboto);
	
	//Add bubble
	
	bubble = game.add.sprite(9100,h+450,'psbubble');
	game.add.text(8900,h+500,"Photography and travelling \n is passion",style_roboto);
...
//	hero.body.gravity.y=10000;
	...
	download_btn = game.add.button(w-150,5,'',openResume,this);
...
function update(){
	...
	*/
	...
	if((bug.x - hero.x)<=100){
		...
		if(bug_killed==false){
		game.add.text(bug.x,h-200,"Great...!!",style_roboto);
		bug_killed =true;
		}
	}
	//Throw onto Ground
